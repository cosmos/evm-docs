...
| -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ------------ |
| **Cosmos [gRPC](./cosmos-grpc.md#cosmos-grpc)**                                  | Query or send Cosmos EVM transactions using gRPC                                     | `9090`       |
| **Cosmos REST ([gRPC-Gateway](./cosmos-grpc.md#cosmos-http-rest-grpc-gateway))** | Query or send Cosmos EVM transactions using an HTTP RESTful API                      | `9091`       |
...
| **CometBFT [RPC](#cometbft-rpc)**                                                | Query transactions, blocks, consensus state, broadcast transactions, etc.            | `26657`      |
| **CometBFT [Websocket](#cometbft-websocket)**                                    | Subscribe to CometBFT ABCI events                                                    | `26657`      |
| **Command Line Interface ([CLI](../../protocol/cli))**                           | Query or send Cosmos EVM transactions using your Terminal or Console.                | N/A          |